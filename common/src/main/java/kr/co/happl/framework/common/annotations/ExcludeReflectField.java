...
package kr.co.happl.framework.common.annotations;
...
/**
 * Reflection 통한 처리시 Field 제외를 처리하기 위한 Annotation
 * - Reflection Code에 직접 조건을 통해 처리해야 한다.
 *
 * @author JI YOONSEONG
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.FIELD)
public @interface ExcludeReflectField {
}
