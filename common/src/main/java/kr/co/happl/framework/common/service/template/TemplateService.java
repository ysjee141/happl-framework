...
package kr.co.happl.framework.common.service.template;
...
public interface TemplateService {
  ...
  <T> void setModel(T model);

  String getContent();

  String getContent(String templateFile);

  String getContent(String templateFile, Object model);
